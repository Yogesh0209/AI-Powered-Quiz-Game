...
public class Main_Menu extends JFrame implements ActionListener {
    ...
    JButton login, startQuiz, mode, profile, help, about, leaderboard, exit;
    ...
    public Main_Menu() {

        {
            ...
            ImageIcon i = new ImageIcon(ClassLoader.getSystemResource("icons/mainmenu.jpg"));
            Image bgImage = i.getImage();
